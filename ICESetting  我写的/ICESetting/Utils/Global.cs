...
namespace TVMWPFLab.Utils
{
    ...
    public class Global
    {
        ...
        #region pack://application:,,,/Images/
        public static ImageSource GetReleativeImageSource(string zamlUrl)
        {
            ...
            return source;
            //ImageSource source = new CroppedBitmap(new BitmapImage(new Uri(@"pack://application:,,,/Images/Btn/editMenu.png", UriKind.RelativeOrAbsolute)), new Int32Rect(i * 30, 0, 30, 30));
        }
        #endregion
